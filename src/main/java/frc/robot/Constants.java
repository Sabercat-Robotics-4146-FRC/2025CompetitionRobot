  ...
  public static final class RobotDesiredPositions {
    ...
    public static final DesiredPosition[] RIGHT_REEFS_L4 = {
      new DesiredPosition(
          "SCORE_11R_L4", 
          new Pose2d(
                  new Translation2d(12.56, 2.76), new Rotation2d(Units.degreesToRadians(58.94)))
    ...
    public static final DesiredPosition[] RIGHT_REEFS = {
      ...
      new DesiredPosition(
          "SCORE_17R", // changed
          new Pose2d(new Translation2d(4.00, 2.84), new Rotation2d(Units.degreesToRadians(59.60)))
              .transformBy(FieldOffsetCompensation.REEF),
          AlgaeLevel.BOTTOM),
      new DesiredPosition(
          "SCORE_18R", // changed
      ...
      new DesiredPosition(
          "SCORE_20R", // changed
          new Pose2d(new Translation2d(4.99, 5.22), new Rotation2d(Units.degreesToRadians(-121.16)))
              .transformBy(FieldOffsetCompensation.REEF),
          AlgaeLevel.TOP),
      new DesiredPosition(
          "SCORE_21R", // changed
      ...
      new DesiredPosition(
          "SCORE_22R", // changed
          new Pose2d(new Translation2d(5.29, 3.01), new Rotation2d(Units.degreesToRadians(119.71)))
              .transformBy(FieldOffsetCompensation.REEF),
          AlgaeLevel.TOP)
    };
    ...
    public static final DesiredPosition[] LEFT_REEFS = {
      ...
      new DesiredPosition(
          "SCORE_20L", // changed
          new Pose2d(new Translation2d(5.25, 4.94), new Rotation2d(Units.degreesToRadians(-123.99)))
              .transformBy(FieldOffsetCompensation.REEF),
          null),
      new DesiredPosition(
          "SCORE_21L", // changed
