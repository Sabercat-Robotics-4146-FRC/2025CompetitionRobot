...
public final class Constants {
  ...
  public static final class RobotDesiredPositions {
    ...
    public static final DesiredPosition[] RIGHT_REEFS = {
      ...
      new DesiredPosition(
          "SCORE_18R", // changed
          new Pose2d(new Translation2d(3.21, 3.86), new Rotation2d(Units.degreesToRadians(-.28)))
              .transformBy(FieldOffsetCompensation.REEF),
          AlgaeLevel.TOP),
      new DesiredPosition(
          "SCORE_19R", // changed
    ...
    public static final DesiredPosition[] LEFT_REEFS = {
      ...
      new DesiredPosition(
          "SCORE_18L", // changed
          new Pose2d(new Translation2d(3.22, 4.16), new Rotation2d(Units.degreesToRadians(4.17)))
              .transformBy(FieldOffsetCompensation.REEF),
          null),
      new DesiredPosition(
          "SCORE_19L", // changed
          new Pose2d(new Translation2d(3.97, 5.16), new Rotation2d(Units.degreesToRadians(-56.07)))
              .transformBy(FieldOffsetCompensation.REEF),
          null),
      new DesiredPosition(
          "SCORE_20L",
      ...
      new DesiredPosition(
          "SCORE_21L", // changed
          new Pose2d(new Translation2d(5.77, 4.21), new Rotation2d(Units.degreesToRadians(179.93)))
              .transformBy(FieldOffsetCompensation.REEF),
          null),
      new DesiredPosition(
          "SCORE_22L",
