...
public class AlignNearestLeftReefL4 extends Command {
  Drive drive;
  RobotContainer container;

  public AlignNearestLeftReefL4(Drive drive, RobotContainer container) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    for (DesiredPosition reef : LEFT_REEFS_L4) {
