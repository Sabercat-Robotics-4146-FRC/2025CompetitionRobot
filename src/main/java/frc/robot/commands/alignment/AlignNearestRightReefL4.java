...
public class AlignNearestRightReefL4 extends Command {
  Drive drive;
  RobotContainer container;

  public AlignNearestRightReefL4(Drive drive, RobotContainer container) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    for (DesiredPosition reef : RIGHT_REEFS_L4) {
